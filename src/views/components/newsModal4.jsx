...
export default (props) => {
  return(<>
  <div aria-hidden="true" className="news-modal modal fade" id="newsModal-4" role="dialog" tabIndex="-1">
        ...
        <div className="row">
          <div className="col-lg-8 col-lg-offset-2">
            <div className="modal-body">
              ...
              <img alt="News Modal" className="img-responsive" src="img/news/news-4.jpg" />
              <p>
